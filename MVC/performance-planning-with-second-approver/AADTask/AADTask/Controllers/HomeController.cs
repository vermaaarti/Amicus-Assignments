    ...
    public class HomeController : Controller
    {
...

        {
...

            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;  //AddDataIntoApproverTableU 

                cmd.CommandText = "AddDataIntoApprovalTaskTableE"; // Use the name of your stored procedure
...

        {
...

            {
                ...
                cmd.Connection = connection;  // ChangeStatusToApprovedI 

                cmd.CommandType = CommandType.StoredProcedure;   //ChangeStatusToApprovedJ

                cmd.CommandText = "ChangeStatusFromAssignedToApprovedsD";  // Use the name of your stored procedure
...

        {
...

            {
                ...
                cmd.CommandText = "ProcedureToCheckRepeatedRecordA";  // Use the name of your stored procedure
